<template>
  <div class="start">
        ...
        <template v-for="(time, index) in store.randomTeams" :key="index">
          ...
          >
            <div class="flex justify-center">
              ...
              >
                {{ time }} <span class="hidden sm:inline pr-2">- (Casa) </span>
                <input
                  class="w-14 mx-2 py-4 text-center"
                  type="number"
                  id="result-time1"
                  placeholder="0"
                />
              ...
              >
                <input
                  class="w-14 mx-2 py-4 text-center order-2 sm:order-1"
                  type="number"
                  id="result-time2"
                  placeholder="0"
                />
            ...
            <button
              class="py-2 mx-auto mt-4 bg-brand-info w-1/2 rounded-full text-white border-2 border-brand-info hover:text-lightseagreen-900 hover:border-lightseagreen-900 hover:bg-brand-gray transition-all duration-500"
            >
              Confirmar resultado
            </button>
          </li>
    ...
    <div class="mx-auto p-4 max-w-screen-lg bg-brand-gray mt-8">
      <p>
        Fase 1
